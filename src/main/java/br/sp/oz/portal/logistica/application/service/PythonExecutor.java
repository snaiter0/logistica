...
public class PythonExecutor {
    ...
    public static FileSystemResource executarConversaoCsv(Set<?> produtos) {
        ...
        try {
            ...
            String scriptPath = new FileSystemResource("C:\\Users\\snaiter\\Desktop\\Projetos Spring boot\\logistica-service\\src\\main\\resources\\scripts\\python\\ProdutoDTO.py").getFile().getAbsolutePath();
